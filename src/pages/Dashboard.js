        ...
        <div class="max-w-7xl ml-7 heropattern py-11 px-3 mr-7  grid grid-cols-12 ">
                   ...
                   <div className="container mx-auto mb-4 bg-gray-100 "> 
                    ...
                    <FlexColumna width={`148px`}>
                        ...
                        <Image1a src={`https://file.rendit.io/n/9Vr3KV0eOirqoe47C5Ev.svg`} />
                           ...
                           <NeonCarrotFlexRowb>
                    <FlexColumna width={`148px`}>
                        <Text1a>Total No Of Student</Text1a>
                        <Text2a>200</Text2a>
                        </FlexColumna>
           ...
           <div className="mx-7 my-4 ">
            <div className="container  mx-auto mb-4">
                    ...
                    <div className="flex justify-center text-6xl border-2 bg-gray-100  p-6 ">
                    <NavLink to="/list-register-student"> 
                    <WhiteFlexColumnRoot1>
                      <Image2 src={`https://file.rendit.io/n/gsdISOR6GGCEjOMXTNt0.svg`} />
                   ...
                   <div className="container mx-auto mb-4"> 
                           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                           <div className="flex justify-center text-6xl border-2 -300 bg-gray-100  p-6 ">
                           <NavLink to="/submitted-result"> 
                           <WhiteFlexColumnRoot1>
                      <Image2 src={`https://file.rendit.io/n/FJ9jVtU8rFr4INlyOUWl.svg`}/>
                      <Text2>Submitted Result</Text2> 
                        </WhiteFlexColumnRoot1>  
                        </NavLink>
                           </div>
                           ...
                           <WhiteFlexColumnRoot1>
                            <Image2 src={`https://file.rendit.io/n/23qga4S9xssuQXl4OB9o.svg`}/>
                           ...
                           <WhiteFlexColumnRoot1>
                            <Image2 src={`https://file.rendit.io/n/BDFfbE4PE1O2L52sR9Hq.svg`} />
                            <Text2>Result History</Text2>
                            </WhiteFlexColumnRoot1>   
                            </NavLink>
                           </div>
