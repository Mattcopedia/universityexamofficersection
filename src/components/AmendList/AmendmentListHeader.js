...
const AmendmentHeader = () => {
  ...
  return (
    ...
    <div>
       ...
       <FlexColumnRoot>
      <Paragraph> Amendment<br className="responsivemodal"></br> List</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/N1cwwddIdOMaExNWA0I7.png`} /> 
       </div>  
...
export default AmendmentHeader