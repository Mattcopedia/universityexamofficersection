...
import AmendmentList from 'components/AmendList/AmendmentList';
import AmendmentHeader from 'components/AmendList/AmendmentListHeader';
    ...
    return ( 
        ...
        {/* <PrivateRoute path="/" exact>
         ...
         <Route exact path="/" component={Dashboard} /> 
            ...
            <Route exact path="/amendment-list" component={AmendmentList} />
            <Route exact path="/amendment-header" component={AmendmentHeader} />  
